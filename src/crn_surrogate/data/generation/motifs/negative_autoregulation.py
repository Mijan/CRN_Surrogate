...
class NegativeAutoregulationParams(MotifParams):
    ...
    k_max: float = param_field(0.5, 500.0)
    k_half: float = param_field(1.0, 200.0)
    n_hill: float = param_field(0.5, 8.0, log_uniform=False)
